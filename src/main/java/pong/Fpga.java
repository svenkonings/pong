...
public class Fpga {
     ...
     * @param fpga_y FPGA y-coordinate of the bottom of the paddle
     * @param field_height height of the field in GUI
     * @return y-coordinate of the top of the paddle in GUI format
     */
    public static double fpga2guiY(int fpga_y, double field_height, double paddle_length) {
        // GUI y coordinate of the bottom of the paddle
        double y = field_height - ((fpga_y - MIN_Y) / HEIGHT) * field_height;
...
//        System.out.println(fpga2guiY(350, 1080) + 1080 * Fpga.REAL_PADDLE_HEIGHT / Fpga.REAL_MAX_Y);
        calibrate(1, 2, 3);
        calibrate(1, 3, 2);
        calibrate(2, 1, 3);
        calibrate(2, 3, 1);
